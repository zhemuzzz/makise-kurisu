...
import { BaseChannel, ChannelConfig } from '../../../../src/platform/gateway/channels/base';
import { ChannelType, InboundMessage, OutboundMessage } from '../../../../src/platform/gateway/types';
