...
import { SessionManager } from "../../../src/platform/gateway/session-manager";
import { ChannelType, type SessionInfo } from "../../../src/platform/gateway/types";
import { InputValidationError } from "../../../src/platform/gateway/errors";
import {
  createMockSession,
  SAMPLE_SESSIONS,
  TIMING_THRESHOLDS,
...
describe("SessionManager", () => {
  ...
  describe("Boundary Cases", () => {
    it("should reject very long session ID", () => {
      ...
      expect(sessionManager.has(longId)).toBe(false);
    });
