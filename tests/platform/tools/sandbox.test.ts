...
import { shouldUseSandbox } from "@/platform/tools/sandbox";
import type { SandboxConfig } from "@/platform/tools/types";
...
describe("SandboxConfig defaults", () => {
  it("should have correct default values", async () => {
    const { DEFAULT_SANDBOX_CONFIG } = await import("@/platform/tools/types");
...
describe("SandboxExecutor instantiation", () => {
  it("should create executor without error", async () => {
    const { createSandboxExecutor } = await import("@/platform/tools/sandbox");
